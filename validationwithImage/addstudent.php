...
<div class="container">
    ...
    <form action="savestudent.php"  method="post" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="number"  value="<?php echo $old_id ?? ''; ?>"   name="id"
                   class="form-control" >
            <p class="text-danger"> <?php echo $id ?? '' ?> </p>
        </div>
        <div class="mb-3">
            <label class="form-label">Name</label>
            <input type="text"   value="<?php echo $old_name ?? ''; ?>"  name="name"
                   class="form-control" >
            <p class="text-danger"> <?php if($name){echo $name;} ?> </p>
        </div>
        <div class="mb-3">
            <label class="form-label">Grade</label>
            <input type="number"  value="<?php echo $old_grade ?? ''; ?>"   name="grade"
                   class="form-control" >
            <p class="text-danger"> <?php if($grade){echo $grade;} ?> </p>
        </div>
        <div class="mb-3">
